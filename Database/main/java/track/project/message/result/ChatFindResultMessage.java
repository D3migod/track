 ...
 */
public class ChatFindResultMessage extends Message implements ResultMessage {
    ...
    public ChatFindResultMessage(List<String> response) {
        this.response = response;
        status = ResultStatus.OK;
    }

    public ChatFindResultMessage(String statusInfo, ResultStatus status) {
        this.statusInfo = statusInfo;
        this.status = status;
    }

    public ChatFindResultMessage(ResultStatus status) {
        this.status = status;
    }
