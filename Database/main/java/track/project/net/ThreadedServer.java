...
public class ThreadedServer {
    ...
    public static void main(String[] args) {
        ...
        UserStore userStore = dbConnector.createUserDatabaseTable();
        MessageStore messageStore = dbConnector.createMessageStoreDatabaseTable(sessionManager);
        ...
        commands.put(CommandType.USER_USER, new UserCommand(userStore));
